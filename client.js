    ...
    window.__ModuleLoader__.load({
      ...
      factory: (require) => {
        ...
        var DECO_PARTS = [
          ...
          ...[
                  "dsh-codex-deco__star dsh-codex-deco__star--sm dsh-codex-deco__star--rose-soft dsh-codex-deco__star--t1 dsh-codex-deco__star--breathe-slow",
                  "dsh-codex-deco__star dsh-codex-deco__star--md dsh-codex-deco__star--rose dsh-codex-deco__star--t2 dsh-codex-deco__star--breathe-slow",
                  "dsh-codex-deco__star dsh-codex-deco__star--sm dsh-codex-deco__star--rose dsh-codex-deco__star--t3 dsh-codex-deco__star--breathe-slow",
                  "dsh-codex-deco__star dsh-codex-deco__star--md dsh-codex-deco__star--rose dsh-codex-deco__star--t4 dsh-codex-deco__star--breathe-slow",
                  "dsh-codex-deco__star dsh-codex-deco__star--sm dsh-codex-deco__star--ochre dsh-codex-deco__star--t5 dsh-codex-deco__star--breathe-slow"
        ]
        ];
